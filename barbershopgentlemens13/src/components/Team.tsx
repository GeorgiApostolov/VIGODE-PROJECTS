    ...
    <section id="team" className="py-20 bg-neutral-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-4">Нашият екип</h2>
          <div className="w-32 h-1 bg-gradient-to-r from-transparent via-red-600 to-transparent mx-auto mb-4"></div>
          <p className="text-neutral-400 text-lg">Майстори на стила и прецизността</p>
        </div>
              ...
              <div className="relative bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 rounded-2xl overflow-hidden transition-all duration-500 hover:border-red-600/50 hover:shadow-2xl">
                <div className="relative aspect-[3/4] sm:aspect-[4/5] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-3xl font-bold text-white mb-2">{barber.name}</h3>
                ...
                <div className="p-6 bg-gradient-to-b from-neutral-900/50 to-black/50 backdrop-blur-sm">
                  <div className="flex items-center space-x-6 text-sm">
                    <div className="flex items-center text-neutral-400">
                      ...
                      <div>
                        <div className="font-semibold text-white">Пон–Съб</div>
                    ...
                    <div className="flex items-center text-neutral-400">
                      ...
                      <div>
                        <div className="font-semibold text-white">Сряда</div>
                  ...
                  <div className="mt-4 pt-4 border-t border-neutral-800">
                    <p className="text-neutral-500 text-sm">
                      <span className="text-red-600 font-semibold">Неделя:</span> {barber.schedule.sunday}
                    </p>
                  </div>
                </div>
